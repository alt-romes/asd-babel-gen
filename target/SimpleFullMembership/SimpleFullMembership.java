...
public class SimpleFullMembership extends GenericProtocol
{
  ...
  private void init (Host myself, Unknown34 ssSize, int t, Host contact)
  {
    self = myself;
  ...
  private void getRandomSubsetExcluding (Unknown34 ms, Set<Host> ss, Host t)
  {
  }
}